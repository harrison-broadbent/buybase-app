...
ActiveRecord::Schema[7.0].define(version: 2023_03_29_224920) do
  ...
  create_table "access_codes", force: :cascade do |t|
    ...
    t.index ["dataset_id"], name: "index_access_codes_on_dataset_id"
  ...
  add_foreign_key "access_codes", "datasets"
